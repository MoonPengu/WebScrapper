...
"background-color: rgb(75, 155, 241);")
        ...
        self.logsTW.setMinimumSize(QtCore.QSize(0, 250))
...
"background-color: rgb(150, 74, 255);")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/bx_bx-home_light.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.webScrapperBtn.setIcon(icon1)
